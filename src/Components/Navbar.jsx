...
import { cartAtom,cartDetailsAtom,cartPriceAtom, notificationAtom} from "../store/page";
        ...
        <ul tabIndex={0} className="menu dropdown-content menu-compact lg:menu-normal bg-base-100 w-56 p-2 rounded-box">
          {notification?.map((item,i)=>(
            <li key={i} className='flex'>
              <div>{item?.message}<button className='text-red-500' onClick={()=>handleclear(i)}>Clear</button></div>
